...
- Keep marketing, editorial, portfolio, and narrative pages on a continuous composition. Do not turn navigation, process steps, proof, features, ordinary prose, and the footer into repeated bordered, filled, elevated, or radius-defined panels. Start unboxed; restore a container only for a named object, action, state, selection, device, or material boundary.
