...
Version 0.4.0 adds constraints-only classification, bounded clarification, diversified pre-lock retrieval, source-derived design/copy records, evidence-backed candidate directions, CONTENT briefs, and factual-drift copy auditing. External-source selection remains bounded, license-aware, inspiration-only where required, and unable to promote knowledge.
